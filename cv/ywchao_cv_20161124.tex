...
\href{http://www.umich.edu}{\textbf{Adobe Research}}, San Jose, CA \hfill {June 2016 -- present} \\
\vspace{-.15in}
\begin{innerlist}
\item[] \emph{Computer Vision Research Intern} \\
    \vspace{-.15in}
    \begin{innerlist}
    \item Mentors: \href{http://http://web.eecs.umich.edu/~jiadeng/}{Jimei Yang, Brian Price, Scott Cohen}
    \end{innerlist}
...
\begin{itemize}[leftmargin=0pt,parsep=3pt,itemsep=0pt,topsep=0pt,partopsep=0pt]
\item[] Programming Languages: MATLAB, Python, C/C++, UNIX shell scripting, JavaScript, and others
\item[] Libraries: Caffe, Torch, OpenCV
