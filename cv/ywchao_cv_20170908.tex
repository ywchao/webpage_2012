...
\href{http://www.umich.edu}{\textbf{University of Michigan}}, Ann Arbor, MI \hfill {Sept 2013 -- present} \\
\vspace{-.15in}
\begin{innerlist}
...
\end{innerlist}
\vspace{.1in}
\href{http://www.umich.edu}{\textbf{University of Michigan}}, Ann Arbor, MI \hfill {Sept 2011 -- Apr 2013} \\
\vspace{-.15in}
\begin{innerlist}
...
\end{innerlist}
\vspace{.1in}
\href{http://www.nctu.edu.tw}{\textbf{National Chiao Tung University}}, Hsinchu, Taiwan \hfill {Sept 2005 -- June 2009} \\
\vspace{-.15in}
\begin{innerlist}
...
% \item[] \textbf{Learning to Detect Human-Object Interactions}\\ \emph{submitted to CVPR 2017}\\ \emph{Yu-Wei Chao}, Yunfan Liu, Xieyang Liu, Huayi Zeng, Jia Deng
...
Reviewer
\begin{innerlist}
\item Computer Vision and Pattern Recognition (CVPR), 2016, 2017
\item International Conference on Computer Vision (ICCV), 2017
\item European Conference on Computer Vision (ECCV), 2016
