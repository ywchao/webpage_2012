...
Computer vision, machine learning, object/activity recognition, 3D scene understanding
...
\begin{itemize}[leftmargin=0pt,parsep=3pt,itemsep=0pt,topsep=0pt,partopsep=0pt]
\item[] Programming Languages: MATLAB, C/C++, OpenCV, Python, UNIX shell scripting, and others
